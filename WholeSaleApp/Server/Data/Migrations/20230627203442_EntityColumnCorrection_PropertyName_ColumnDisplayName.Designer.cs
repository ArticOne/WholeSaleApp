...
namespace WholeSaleApp.Server.Migrations
{
    ...
    [Migration("20230627203442_EntityColumnCorrection_PropertyName_ColumnDisplayName")]
    partial class EntityColumnCorrection_PropertyName_ColumnDisplayName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WholeSaleApp.Shared.Model.UI.EntityColumn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WholeSaleApp.Shared.Model.UI.EntityGrid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WholeSaleApp.Shared.Model.UI.EntityColumn", b =>
                {
                    b.HasOne("WholeSaleApp.Shared.Model.UI.EntityGrid", "EntityGrid")
                        .WithMany("EntityColumns")
                        .HasForeignKey("EntityGridId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EntityGrid");
                });
